...
const forecast = (longitude, latitude, callback) =>{
    const url = 'http://api.weatherstack.com/current?access_key=acd9304b5df7ef0d7934fe5c5ab15f77&query=' + encodeURIComponent(longitude)+','+encodeURIComponent(latitude);
